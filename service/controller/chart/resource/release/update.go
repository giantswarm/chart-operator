...
func (r *Resource) ApplyUpdateChange(ctx context.Context, obj, updateChange interface{}) error {
	...
	if helmclient.IsResourceAlreadyExists(err) {
		...
		r.logger.Errorf(ctx, err, "helm release failed, resource already exists: %s, release=%q", releaseState.Name)
		...
		r.logger.Errorf(ctx, err, "helm release failed, validation error: %s, release=%q", releaseState.Name)
		...
		r.logger.Errorf(ctx, err, "helm release failed, invalid manifest: %s, release=%q", releaseState.Name)
