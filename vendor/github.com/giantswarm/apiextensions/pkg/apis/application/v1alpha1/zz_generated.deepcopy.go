...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *ChartStatusValues) DeepCopyInto(out *ChartStatusValues) {
	*out = *in
	return
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ChartStatusValues.
func (in *ChartStatusValues) DeepCopy() *ChartStatusValues {
	if in == nil {
		return nil
	}
	out := new(ChartStatusValues)
	in.DeepCopyInto(out)
	return out
}
