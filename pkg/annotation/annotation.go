...
const (
	...
	// RollbackCounts is the name of the annotation that indicates
	// the number of rollback did since get stuck in pending status.
	RollbackCounts = "chart-operator.giantswarm.io/rollback-counts"
